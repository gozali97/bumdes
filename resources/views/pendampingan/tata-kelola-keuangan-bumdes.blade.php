         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pendampingan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Pendampingan Tata Kelola Keuangan BUMDES</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pendampingan Tata Kelola Keuangan ini diberikan kepada BUMDES yang baru di bentuk atau BUMDES yang belum memiliki sertifikat badan hukum. Pendampingan dilaksanakan
                  secara offline (luring) dan online (daring).
               </p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Melakukan pendampingan mengenai Tata Kelola Keuangan BUMDES sesuai dengan PP 11 Tahun 2021, Permendesa No 3 Tahun 2021 dan SAK ETAP. </li>
                        <li class="mb-2">Transfer Knowledge kepada Stakeholder Desa terutama Pemerintah Desa dan Pengelola BUMDES dalam pelaksanaan Tata Kelola Keuangan BUMDES.
                        </li>
                     </ol>
                  </div>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="dokumen">
                     ...
                     <div class="d-flex align-items-center mb-2 flex-wrap">
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Laporan Realisasi Anggaran</span>
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Laporan Keuangan Konsolidasi</span>
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Laporan Keuangan Unit Usaha</span>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeTiga">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeTiga" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeTiga">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Pelatihan Tata kelola Keungan</li>
                                    <li>Analisa/Revie Dokumen</li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeEmpat">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeEmpat" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeEmpat">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Pendampingan Penyusunan Anggaran BUM Desa</li>
                                    <li>Pendampingan Review Keuangan Tahun Sebelumnya</li>
                                    <li>Pendampingan Penyusunan Laporan Keuangan tahun Berjalan</li>
                                    <li>Pendampngan Perpajakan BUMDES</li>
                                    <li>Pedandampingan Implementasi SAAB</li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="accordion-item accordion-item-metode rounded-5">
                           <h6 class="small accordion-header">
                              <button class="btn-accordion-metode accordion-button small bg-transparent" type="button" data-bs-toggle="collapse"
                                 ...
                                 5. Pemaparan Dokumen Hasil Pendampingan
                              </button>
                           </h6>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeEnam">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeEnam" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeEnam">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Rivew & BAST Hasil Pendampingan</li>
                                    <li>Penyusunan Laporan Hasil Pendampingan</li>
                        ...
                        <div class="accordion-item accordion-item-metode rounded-5">
                           <h6 class="small accordion-header">
                              <button class="btn-accordion-metode accordion-button small bg-transparent" type="button" data-bs-toggle="collapse"
                                 ...
                                 7. Monitoring dan Evaluasi Selama 1 Tahun
                              </button>
                           </h6>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="jadwal">
                     ...
                     <div class="card card-body rounded-5 border-2 p-4 shadow-sm">
                        ...
                        <div class="mt-4 overflow-hidden rounded text-center">
                           <img src="{{ asset('assets/home/img/jadwal-pelaksanaan-tata-kelola-Keuangan-bumdes.png') }}" alt="gambar jadwal pelaksanaan" class="img-fluid">
                        </div>
                     </div>
                  </div>
