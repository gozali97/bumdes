         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pendampingan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Pendampingan Tata Kelola Kelembagaan BUMDES</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pendampingan Tata Kelola Kelembagaan ini diberikan kepada BUMDES yang baru di bentuk atau BUMDES yang belum memiliki sertifikat badan hukum. Pendampingan
                  dilaksanakan secara offline (luring) dan online (daring).
               </p>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="jadwal">
                     ...
                     <div class="card card-body rounded-5 border-2 p-4 shadow-sm">
                        ...
                        <div class="mt-4 overflow-hidden rounded text-center">
                           <img src="{{ asset('assets/home/img/jadwal-pelaksaan-tata-kelola-kelembagaan-bumdes.png') }}" alt="gambar jadwal pelaksanaan" class="img-fluid">
                        </div>
                     </div>
                  </div>
