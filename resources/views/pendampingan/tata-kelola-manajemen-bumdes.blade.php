         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pendampingan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Pendampingan Tata Kelola Manajemen BUMDES</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pendampingan Tata Kelola Manajemen ini diberikan kepada BUMDES di level rintisan, tumbuh dan maju yang belum memiliki GCG yang baik. Pendampingan dilaksanakan secara
                  offline (luring) dan online (daring).
               </p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Memberikan pendampingan tata kelola manajemen BUMDES.</li>
                        <li class="mb-2">Memberikan pendampingan penyusunan dokumen administrasi BUMDES.</li>
                        <li class="mb-2">Transfer Knowledge kepada Stakeholder Desa terutama Pemerintah Desa dan Pengelola BUMDES dalam pelaksanaan Tata Manajemen BUMDES.</li>
                     </ol>
                  </div>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="dokumen">
                     ...
                     <div class="d-flex align-items-center mb-2 flex-wrap">
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">SOP Unit Usaha</span>
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">SOP Keuangan BUMDES</span>
                        ...
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Laporan Pertanggungjawaban BUMDES sesuai
                           Permendesa No 3 Tahun 2021</span>
                     </div>
                  </div>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeTiga">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeTiga" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeTiga">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Pelatihan Penyusunan SOP Unit USaha dan SOP Keuangan</li>
                                    <li>Pengumpulan Dokumen</li>
                                    <li>Mengisi CKU-B</li>
                                    <li>Analisa/Riview Dokumen</li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeEnam">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeEnam" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeEnam">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Riview dan BAST Hasil Pedanpingan</li>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="jadwal">
                     ...
                     <div class="card card-body rounded-5 border-2 p-4 shadow-sm">
                        ...
                        <div class="mt-4 overflow-hidden rounded text-center">
                           <img src="{{ asset('assets/home/img/jadwal-pelaksaan-tata-kelola-manajemen-bumdes.png') }}" alt="gambar jadwal pelaksanaan" class="img-fluid">
                        </div>
                     </div>
                  </div>
