         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pendampingan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Pendampingan Digitalisasi BUMDES</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pendampingan Digitalisasi BUMDES ini ditujukan bagi BUMDES yang belum secara optimal mengelola sosial media dan penjualannya secara online, BUMDES yang belum
                  memiliki website ataupun belum optimal dalam mengelola websitenya secara profesional.
               </p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Melakukan pendampingan Digitalisasi BUMDES dari teknik digital marketing, marketplace, optimalisasi social media dan pembuatan website</li>
                        <li class="mb-2">Transfer Knowledge kepada Stakeholder Desa terutama Pemerintah Desa dan Pengelola BUMDES mengenai pentingnya digitalisasi bagi BUMDES untuk
                           meningkatkan perekonomian desa.</li>
                     </ol>
                  </div>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="dokumen">
                     ...
                     <div class="d-flex align-items-center mb-2 flex-wrap">
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Website BUMDES</span>
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Toolkit Optimalisasi Sosial Media Keuangan
                           Konsolidasi</span>
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">E-Katalog BUMDES</span>
                     </div>
                  </div>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeTiga">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeTiga" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeTiga">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Pelatihan Digitalisasi BUM Desa</li>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeEmpat">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeEmpat" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeEmpat">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Pendampingan Pembuatan Website/ Optimaslisasi Website</li>
                                    <li>Pendampingan Optimalisasi Sosial Media</li>
                                    <li>Pendmapingan Pembuatan Konten dan E-Katalog</li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="accordion small mb-3" id="accordionMetodeEnam">
                        <div class="accordion-item accordion-item-metode rounded-5">
                           ...
                           <div id="collapseMetodeEnam" class="accordion-collapse collapse" data-bs-parent="#accordionMetodeEnam">
                              <div class="accordion-body small">
                                 <ul>
                                    <li>Rivie dan BAST Hasil Pendampingan</li>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="jadwal">
                     ...
                     <div class="card card-body rounded-5 border-2 p-4 shadow-sm">
                        ...
                        <div class="mt-4 overflow-hidden rounded text-center">
                           <img src="{{ asset('assets/home/img/jadwal-pelaksanaan-digitalisasi  -bumdes.png') }}" alt="gambar jadwal pelaksanaan" class="img-fluid">
                        </div>
                     </div>
                  </div>
