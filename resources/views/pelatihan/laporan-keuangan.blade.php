         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pelatihan -->
                  <h3 class="fw-bold" style="line-height: 40px">Pelatihan Penyusunan Laporan Keuangan BUM Desa</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pelatihan ini ditujukan untuk BUM Desa untuk meningkatkan Kapasitas Bendahara BUM Desa dalam tata kelola keuangan BUM Desa, Memberikan wawasan dalam penyusunan
                  anggaran BUM Desa, Memberikan wawasan dalam penyusunan laporan keuangan BUM Desa sesuai dengan PP 11 Tahun 2021 dan Permendesa No 3 Tahun 2021. Pelatihan
                  dilaksanakan selama 2 hari, pelatihan berlokasi di sekolah bumdes (Bumdes.id) di Yogyakarta.
               </p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Meningkatkan Kapasitas Bendahara BUM Desa dalam tata kelola keuangan BUM Desa.</li>
                        <li class="mb-2">Memberikan wawasan dalam penyusunan anggaran BUM Desa.</li>
                        <li class="mb-2">Memberikan wawasan dalam penyusunan laporan keuangan BUM Desa sesuai dengan PP 11 Tahun 2021 dan Permendesa No 3 Tahun 2021.</li>
                     </ol>
                  </div>
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="fasilitas">
                     ...
                     <div class="d-flex align-items-center mb-2 flex-wrap">
                        ...
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Free Trial SAAB 1 tahun</span>
                        <span class="badge rounded-pill text-secondary fw-normal me-3 mb-3 border border-2 bg-transparent px-3 py-2">Join komunitas Bumdes.id</span>
                     </div>
                  </div>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriSatu">
                                 Tata keuangan BUM Desa sesuai PP 11 Tahun 2021 dan Pemendesa No 3 Tahun 2021
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriDua">
                                 Penyusunana anggaran BUM Desa 1 periode akuntansi
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriTiga">
                                 Praktikum SAAB (Anggaran & Penerimaan)
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriEmpat">
                                 Praktikum SAAB (Transaksi Pengeluaran , Akuntansi & Laporan Keuangan)
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item accordion-item-pemateri rounded-5">
                           <h6 class="small accordion-header">
                              <button class="btn-accordion-pemateri accordion-button small bg-transparent" type="button" data-bs-toggle="collapse"
                                 ...
                                 <div class="row align-items-center w-100">
                                    <div class="col-2 col-md-3 col-lg-1">
                                       <img src="{{ asset('assets/home/img/pemateri/img-prof-gunawan-sumodiningrat.png') }}" alt="Prof. Gunawan Sumodiningrat"
