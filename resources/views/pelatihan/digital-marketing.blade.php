         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pelatihan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Pelatihan Digital Marketing BUM Desa
                  </h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pelatihan ini ditujukan untuk BUM Desa dapat memberikan wawasan kepada stake holder desa tentang filosofi BUM Desa dan pentingnya tranformasi digital bagi BUM Desa.
                  Mengajarkan cara membuat konten digital yang dapat digunakan BUM Desa mempromosikan usahanya. Pelatihan ini dilakukan selama 2 hari berlokasi di sekolah bumdes
                  (Bumdes.id) Jl. Nogotirto, 15B, Gamping, Sleman, D I Yogykarta.
               </p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        ...
                        <li class="mb-2">Memberikan wawasan kepada stake holder desa (Pemdes, BPD, BUM Desa, Pemuda, PKK)  tentang pentingnya tranformasi digital bagi BUM Desa.</li>
                        <li class="mb-2">Mengajarkan bagaimana cara membuat konten digital yang dapat digunakan BUM Desa untuk mempromosikan usahanya.</li>
                     </ol>
                  </div>
