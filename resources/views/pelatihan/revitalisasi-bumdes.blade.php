         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pelatihan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Pelatihan Revitalisasi BUM Desa Paska PP 11 tahun 2021</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pelatihan ini ditunjukan untuk BUM Desa memberikan wawasan kepada stake holder desa tentang filosofi BUM Desa dan penyusunan Perdes, AD, ART BUM Desa Sesuai dengan
                  PP 11 Tahun 2021 dan Permendesa No 3 Tahun 2021. Menyamakan goal setting antara kepala desa, BPD, BUM Desa, PKK dan Pemuda untuk memajukan BUM Desa. Pelatihan ini
                  dilakukan selama 2 hari berlokasi di sekolah bumdes (Bumdes.id) Jl. Nogotirto, 15B, Gamping, Sleman, D I Yogyakarta.
               </p>
         ...
         <div class="row py-4">
            ...
            <div class="col-md-7 col-lg-9">
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Memberikan wawasan kepada stake holder desa (Pemdes, BPD, BUM Desa, Pemuda, PKK) tentang filosofi BUM Desa.</li>
                        <li class="mb-2">Memberikan wawasan kepada stake holder desa (Pemdes, BPD, BUM Desa, Pemuda, PKK)  tentang penyusunan Perdes, AD, ART BUM Desa Sesuai dengan PP 11 Tahun 2021 dan Permendesa No 3 Tahun 2021.</li>
                        <li class="mb-2">Menyamakan goal setting antara kepala desa, BPD, BUM Desa, PKK dan Pemuda untuk memajukan BUM Desa.</li>
                     </ol>
                  </div>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriSatu">
                                 Filosofi dan Goal Setting BUM Desa
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriDua">
                                 Sharing session BUM Desa Percontohan
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriEmpat">
                                 Praktikum Penyusunan ART BUM Desa Perdes dan AD BUM Desa Sesuai PP 11 Tahun 2021 dan Permendesa No 3 Tahun 2021
                              </button>
                           </h6>
               ...
               <div class="card card-body card-training rounded-5 bg-green text-light mb-4 border-0 p-4" id="biaya">
                  ...
                  <p class="my-0 mb-3">Biaya kontribusi peserta sebesar <span class="fw-bold">Rp. 2.500.000/Orang</span></p>
