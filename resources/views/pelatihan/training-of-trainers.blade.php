         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pelatihan -->
                  <h3 class="fw-bold" style="line-height: 40px">Training Of Trainers Pendampingan Bumdes</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pelatihan ini ditujukan untuk BUM Desa dapat Memberikan wawasan , Memberikan wawasan tentang kelayakan usaha. dan dapat Memberikan wawasan tentang tata kelola BUMDES
                  yang baik. pelatihan ini dilakukan selama 3 hari berlokasi di sekolah bumdes (Bumdes.id) Jl. Nogotirto, 15B, Gamping, Sleman, D I Yogykarta.
               </p>
               <p class="small text-muted my-3">Biaya Kontribusi <span class="text-danger fw-bold">Rp. 3.000.000/Orang</span></p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Memberikan wawasan tentang potensi Desa kepada peserta pelatihan (pengelola BUMDES).</li>
                        <li class="mb-2">Memberikan wawasan tentang kelayakan usaha.</li>
                        <li class="mb-2">Memberikan wawasan tentang tata kelola BUMDES yang baik.</li>
                     </ol>
                  </div>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriSatu">
                                 Filosofi & Revitalisasi BUMDes Paska PP 11/2021 dan Permendesa 3/2021
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriDua">
                                 Tata Kelola dan Keuangan BUMDes
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriTiga">
                                 Sharing Praktik Terbaik Pengelolaan BUMDes
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriLima">
                                 Praktik Penyusunan Studi Kelayakan Usaha
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriTujuh">
                                 Praktik Penyusunan Laporan Keuangan BUMDES menggunakan (SAAB)
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriDelapan">
                                 Studi Lapangan ke BUMDes Inspiratif
                              </button>
                           </h6>
