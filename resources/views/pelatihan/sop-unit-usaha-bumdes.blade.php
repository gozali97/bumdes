         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pelatihan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Pelatihan Penyusunan SOP Unit Usaha BUM Desa</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pelatihan ini ditunjukan untuk BUM Desa memberikan wawasan kepada pengelola BUM Desa tentang Standar Operasional Prosedur aktivitas usaha BUM Desa, pengelola BUM
                  Desa tentang Standar Operasional Prosedur Keuangan BUM Desa dan wawasan kepada pengelola BUM Desa untuk menganalisa kegiatan operasional BUM Desa. Pelatihan ini
                  dilakukan selama 2 hari berlokasi di sekolah bumdes (Bumdes.id) Jl. Nogotirto, 15B, Gamping, Sleman, D I Yogykarta.
               </p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Memberikan wawasan kepada pengelola BUM Desa tentang Standar Operasional Prosedur aktivitas usaha BUM Desa.</li>
                        <li class="mb-2">Memberikan wawasan kepada pengelola BUM Desa tentang Standar Operasional Prosedur Keuangan BUM Desa.</li>
                        <li class="mb-2">Memeberikan wawasan kepada pengelola BUM Desa untuk menganalisa kegiatan operasional BUM Desa.</li>
                     </ol>
                  </div>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriDua">
                                 Praktikum Penyusunan SOP Unit Usaha BUM Desa
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriTiga">
                                 Materi Tentang SOP Keuangan BUM Desa
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriEmpat">
                                 Praktikum Penyusunan SOP Keuangan BUM Desa
                              </button>
                           </h6>
