         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-7 order-md-0 small order-1">
               <div class="col-lg-9 mt-md-0 mt-3">
                  <!-- judul pelatihan -->
                  <h3 class="fw-bold" style="line-height: 40px">Term of Refrence (TOR) Kunjungan Sekolah BUMDES</h3>
               </div>
               ...
               <p class="text-secondary lh-lg small mt-3 mb-0">
                  Pelatihan ini ditunjukan untuk BUM Desa memberikan wawasan tentang Badan Usaha Milik Desa, wawasan tentang program pelatihan dan pendidikan BUMDes, dan wawasan
                  tentang program/produk yang diperlukan BUMDes; Pemetaan Bentang, Cek Kesehatan Usaha, dan Sistem Aplikasi Akuntasi Bumdes. Pelatihan ini dilakukan selama 2 hari
                  berlokasi di sekolah bumdes (Bumdes.id) Jl. Nogotirto, 15B, Gamping, Sleman, D I Yogykarta.
               </p>
               ...
               <div id="nav-content-training">
                  ...
                  <div class="card card-body card-training rounded-5 mb-4 border-2" id="tujuan">
                     ...
                     <ol class="small" style="color: #555">
                        <li class="mb-2">Memberikan wawasan tentang Badan Usaha Milik Desa kepada peserta kunjungan.</li>
                        <li class="mb-2">Memberikan wawasan tentang program pelatihan dan pendidikan BUMDes.</li>
                        <li class="mb-2">Memberikan wawasan tentang program/produk yang diperlukan BUMDes; Pemetaan Bentang, Cek Kesehatan Usaha, dan Sistem Aplikasi Akuntasi Bumdes.</li>
                     </ol>
                  </div>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriSatu">
                                 Filosofi & Revitalisasi BUMDes Paska PP 11/2021
                              </button>
                           </h6>
                        ...
                        <div class="accordion-item rounded-5">
                           <h6 class="small accordion-header">
                              <button class="accordion-button small bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMateriTiga">
                                 Showing Sistem Aplikasi Akuntansi BUMDes
                              </button>
                           </h6>
