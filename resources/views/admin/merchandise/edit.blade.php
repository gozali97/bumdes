                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12 mt-5">
                            <form accept-charset="UTF-8" action="{{ route('admin.merch.update', $merchandise->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group {{ $errors->has('nama_produk') ? 'has-error' : '' }}">
                                            <label class="text-success" for="nama_produk">Nama Produk</label>
                                            <input type="text" name="nama_produk" class="form-control border" id="nama_produk" value="{{ $merchandise->nama_produk ?? old('nama_produk') }}" placeholder="Nama Produk">
                                        ...
                                        <div class="form-group {{ $errors->has('stok') ? 'has-error' : '' }}">
                                            ...
                                            <input type="number" name="stok" class="form-control border" id="stok" value="{{ $merchandise->stok ?? old('stok') }}" placeholder="Stok">
                                            @if ($errors->has('stok'))
                                            <p class="alert alert-warning">
                                                {{ $errors->first('stok') }}
                                            </p>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group {{ $errors->has('harga') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" name="harga" class="form-control border" id="harga" value="{{ $merchandise->harga ?? old('harga') }}" placeholder="Harga">
                                            @if ($errors->has('harga'))
                                            <p class="alert alert-warning ">
                                                {{ $errors->first('harga') }}
                                            </p>
                                        ...
                                        <div class="form-group {{ $errors->has('details') ? 'has-error' : '' }}">
                                            ...
                                            <textarea class="form-control border" name="details" id="details" rows="5" value="{{ old('details') }}" placeholder="Details">{{$merchandise->details}}</textarea>
