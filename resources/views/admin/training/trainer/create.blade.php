                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-card-primer">
                                <h3 class="card-title">Masukan data pemateri</h3>
                            </div>
                            <div class="card-body">
                                <div class="col-md-6 offset-md-3 mt-5">
                                    <form accept-charset="UTF-8" action="{{ route('admin.training.trainer.store') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf

                                        <div class="form-group {{ $errors->has('trainer_name') ? 'has-error' : '' }}">
                                            <label class="text-success" for="trainer_name">Pemateri</label>
                                            <input type="text" name="trainer_name" class="form-control " id="trainer_name"
                                                value="{{ old('trainer_name') }}" placeholder="Pemateri">
