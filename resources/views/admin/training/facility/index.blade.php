                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-card-primer">
                                <h3 class="card-title">Tambah Fasilitas Pelatihan</h3>
                                <div class="card-tools">
                                    <a href="{{ route('admin.training.facility.create') }}" class="btn btn-print"><i
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="d-grid gap-2 d-md-block">
                                                            ...
                                                            <a href="{{ route('admin.training.facility.edit', $facility->id) }}"
                                                                class="btn btn-warning"><i class=" fas fa-edit"></i></a>
                                                            <button id="delete"
                                                                data-title="{{ $facility->facility_name }}"
                                                                href="{{ route('admin.training.facility.destroy', $facility->id) }}"
