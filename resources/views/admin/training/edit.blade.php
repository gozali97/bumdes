                                        ...
                                        <div class="form-row"">
                                            <div class="col">
                                                <div
                                                    ...
                                                    <label class="text-success" for="title">Judul Pelatihan</label>
                                                    <input type="text" name="title" class="form-control"
                                                        id="title" value="{{ $training->title }}">
                                                    @if ($errors->has('title'))
                                                ...
                                                <div
                                                    ...
                                                    <input id="description" value="{{ $training->description ?? old('description') }}" type="hidden" name="description">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group {{ $errors->has('trainer') ? 'has-error' : '' }}">
                                                   ...
                                                   <select name="trainer[]" id="trainer" class="form-control select2" multiple="multiple">
                                                        ...
                                                        <option value="{{ $trainer->id }}" selected>{{ $trainer->trainer_name  }}</option>
                                                        @endforeach
                                                ...
                                                <div
                                                    class="form-group {{ $errors->has('purposes') ? 'has-error' : '' }}">
                                                    <label class="text-success" for="purposes">Tujuan Pelatihan</label>
                                                    {{-- <textarea type="text" name="purposes" class="form-control " id="purposes" rows="5">
                                                    {!! $training->purposes !!}</textarea> --}}
                                                    <input id="purposes" value="{{ $training->purposes ?? old('purposes') }}" type="hidden" name="purposes">
                                                ...
                                                <div
                                                    ...
                                                    <input type="text" name="video_link" class="form-control"
                                                        id="video_link" value="{{ $training->video_link }}">
