                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-md-6 offset-md-3 mt-5">
                                    <form accept-charset="UTF-8" action="{{ route('admin.event.store') }}" method="POST"
                                        ...
                                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                                            ...
                                            <input type="date" name="start_date" class="form-control datetimepicker " id="start_date"
                                                value="{{ old('start_date') }}" placeholder="Mulai Kegiatan">
                                        ...
                                        <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                                            ...
                                            <input type="date" name="end_date" class="form-control datetimepicker " id="end_date"
                                                value="{{ old('end_date') }}" placeholder="Selesai Kegiatan">
