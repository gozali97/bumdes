                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-card-primer">
                                <h3 class="card-title">Masukan data arsip</h3>
                            </div>
                            <div class="card-body">
                                <div class="col-md-6 offset-md-3 mt-5">
                                    <form accept-charset="UTF-8" action="{{ route('admin.archives.store') }}" method="POST"
                                        ...
                                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                            <label class="text-success" for="name">Nama Arsip</label>
                                            <input type="text" name="name" class="form-control border" id="name"
                                                value="{{ old('name') }}" placeholder="Nama arsip">
                                            @if ($errors->has('name'))
                                                <p class="alert alert-warning ">
                                                    {{ $errors->first('name') }}
                                                </p>
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input class="btn btn-success" type="file" name="path">
                                            @if ($errors->has('path'))
                                                <p class="alert alert-warning ">
                                                    {{ $errors->first('path') }}
                                                </p>
